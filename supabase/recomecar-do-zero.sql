...
-- ===== supabase/migrations/0013_cache_de_previsao.sql =====
-- =============================================================================
...
-- ===== supabase/migrations/0014_registrar_pagamento.sql =====
-- =============================================================================
...
-- ===== supabase/migrations/0015_preparar_cobranca.sql =====
-- =============================================================================
...
-- ===== supabase/migrations/0016_webhook.sql =====
-- =============================================================================
...
-- contrato-adesao-guia.md  (sha256 2f3cc542297f50cb0ec6504e7ecba6e27b60bb0a7d79166dcb12f442abacde0d)
insert into public.legal_documents (slug, versao, titulo, corpo_markdown)
values ('contrato_guia', '1.2', $doc$Contrato de Adesão — Guia de Pesca$doc$, $doc$> **AVISO — ESTE DOCUMENTO É UMA MINUTA.** Foi redigido como ponto de partida técnico e precisa de
